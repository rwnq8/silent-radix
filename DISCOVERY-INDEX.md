...
- **Pages:** Landing, Archimedean Interface (D3.js), Quantum Computing paper
- **Status:** Live, all pages verified
...
| 2 | silent-radix-synthesis-paper.tex | LaTeX source (arXiv-ready) | ✅ |
| 3 | silent-radix-synthesis-paper.pdf | Compiled 9-page PDF | ✅ |
| 4 | consequence-atlas-v1.0.md | 50-entry error catalog | ✅ |
| 5 | consequence-atlas-supplement-v1.0.md | 15 additional entries | ✅ |
| 6 | consequence-atlas-expansion-v2.0.md | 142 entries (Sections G-T), 207 combined | ✅ |
| 7 | formal-appendix-silent-radix-theorem.md | 8 formal theorems | ✅ |
| 8 | explicit-frame-pattern-language-v1.0.md | 9 design patterns | ✅ |
| 9 | lof-number-builder-specification-v1.0.md | Interactive tool spec | ✅ |
| 10 | cross-reference-index-v1.0.md | Atlas↔Paper mapping | ✅ |
| 11 | README-silent-radix-research-program.md | Master index | ✅ |
| 12 | archimedean-interface-viz.html | D3.js dual-geometry visualization | ✅ |
...
| Section | Domain | Entries |
|---------|--------|:-------:|
| A | Computing & Software | 1-10 |
| B | Science & Mathematics | 11-20 |
| C | Infrastructure & Engineering | 21-30 |
| D | Economics & Finance | 31-40 |
| E | Governance & Public Policy | 41-50 |
| F | Cross-Domain | 51-65 |
| G | Cryptography & Security | 66-75 |
| H | AI, ML & Data Science | 76-90 |
| I | Finance & Economics | 91-105 |
| J | Legal & Regulatory | 106-115 |
| K | Healthcare & Medicine | 116-125 |
| L | Military & Defense | 126-133 |
| M | Transportation & Navigation | 134-142 |
| N | Environmental Science & Climate | 143-151 |
| O | Media, Journalism & Communications | 152-160 |
| P | Education & Pedagogy | 161-169 |
| Q | History, Archaeology & Heritage | 170-178 |
| R | Physics & Fundamental Science | 179-187 |
| S | Biology, Genetics & Medicine | 188-196 |
| T | Architecture, Engineering & Standards | 197-207 |
